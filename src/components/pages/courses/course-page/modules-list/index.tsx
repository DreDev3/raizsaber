  ...
  return (
    <aside
      className={cn(
        ...
        'min-w-95 max-w-95 transition-all',
        !modulesListCollapsed && 'fixed top-0 bottom-0 right-0 z-10 sm:relative',
        modulesListCollapsed && 'w-18 max-w-18 min-w-18 hidden sm:flex'
      )}
    >
      <div
        className='absolute z-10 left-0 top-0 bottom-0 w-4 flex justify-start group cursor-e-resize'
