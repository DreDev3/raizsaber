...
export const LessonsList = ({ moduleIndex, onEditLesson }: LessonsListProps) => {
                  ...
                  {(provided) => (
                    ...
                    >
                      <div
                        ...
                        className='w-fill h-full bg-muted/50 flex items-center justify-center'
                      >
                      ...
                      <div className='w-full h-full flex items-center justify-between gap-4 p-3'>
                        ...
                        <div className='flex items-center gap-3'>
                          <Tooltip content='Editar aula'>
                            <Button variant='outline' size='icon' onClick={() => onEditLesson(field)}>
                              <Pen />
                            </Button>
                          </Tooltip>
